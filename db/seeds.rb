...
t1 = Ticket.create(title: 'Computer Crashed', description: "Hit it was golf club and now it doesn't work", priority: '1 - High', category: 'Hardware', company: c1, user: u1)
t2 = Ticket.create(title: 'Software Needed', description: "Need software to steal money", priority: '1 - High', category: 'Software', company: c1, user: u1)
t3 = Ticket.create(title: 'Squirrel Ate Mouse', description: "Need a new one", priority: '2 - Medium', category: 'Hardware', company: c1, user: u1)
t4 = Ticket.create(title: 'Google Not Working', description: "Keeps telling me to try again", priority: '3 - Low', category: 'Software', company: c1, user: u1)
