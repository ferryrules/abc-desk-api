...
e1 = Employee.create(full_name: "Ferris Boran", pay_type: "Salary", pay_rate: 300000.99, filing_status: 'Single', w4_allowances: 0, company: c1)

d1 = Department.create(name: "CAO", company: c1, employee: e1)

u1 = User.create(email: 'ferris@ferryrules.com', username: 'ferryrules', password_digest: 'asd', permission: 'God', company: c1)

t1 = Ticket.create(title: 'Computer Crashed', description: "Hit it was golf club and now it doesn't work", priority: 'High', category: 'Hardware', user: u1, company: c1)
